...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            /**
             * Listen to the global shortcuts (sent from background process).
             */
            listenToGlobalShortcuts() {
                ipc.on('shortcut', (e, msg) => {
                    switch (msg) {
                        ...
                        case 'MediaPlayPause':
                            return $('#mainFooter .play:visible, #mainFooter .pause:visible').click();
                    }
                });
            },

            /**
             * Listen to other commands sent from background process, for example app menu commands.
             */
            listenToCommands() {
                ipc.on('cmd', (e, msg) => {
                    switch (msg) {
                        case 'ShowAboutPanel':
                            return this.$refs.aboutPanel.show();
                    }
                });
            },
